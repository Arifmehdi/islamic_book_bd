            ...
            <div class="carousel-item {{ $key == 0 ? 'active' : '' }}" style="background-image: url('{{ route('imagecache', ['template' => 'original', 'filename' => $slider->fi()]) }}');">
                <div class="carousel-caption">
                    <div class="caption-content">
                        <p class="mb-3">{{ $slider->sub_title ?? 'Welcome to Islamic Book BD.Com' }}</p>
...
<section class="ad-about-section">
    <div class="container ad-about-container">
        ...
        <div class="ad-about-text-container">
            ...
            <h4>
                {!! $content->title ?? 'Islamic Book BD <br class="d-none d-xxl-block"> Nourishing Souls with Knowledge.' !!}
            </h4>
            <p>
                {{ $content->description ?? 'Islamic Book BD is Bangladesh\'s leading online platform for authentic Islamic literature. We connect readers with the profound wisdom of the Quran, Hadith, and scholarly works, ensuring that every home has access to reliable spiritual guidance and knowledge.' }}
            </p>
            <div class="ad-about-list-container">
                ...
                @else
                    <div class="d-flex gap-3 align-items-center">
                        <i class="fa-regular fa-square-check"></i>
                        <p>Wide collection of authentic Islamic books</p>
                    </div>
                    <div class="d-flex gap-3 align-items-center">
                        <i class="fa-regular fa-square-check"></i>
                        <p>Sourced from renowned Islamic publishers</p>
                    </div>
                    <div class="d-flex gap-3 align-items-center">
                        <i class="fa-regular fa-square-check"></i>
                        <p>Quran, Hadith, and scholarly literature</p>
                    </div>
                    <div class="d-flex gap-3 align-items-center">
                        <i class="fa-regular fa-square-check"></i>
                        <p>Fast and reliable home delivery nationwide</p>
                    </div>
                @endif
            </div>
...
<section data-aos="fade-up">
    <div class="ad-service">
        <div class="ad-service-title-container">
            ...
            <h4>{{ $content->meta['process_title'] ?? 'Our Commitment to Quality' }}</h4>
            <p>
                {{ $content->meta['process_subtitle'] ?? 'From careful book selection to safe delivery, we ensure you receive only the best in Islamic literature.' }}
            </p>
        </div>
                            ...
                            <div class="d-flex justify-content-between align-items-baseline gap-2">
                                <div class="ad-offer-card-text-container flex-grow-1">
                                    ...
                                    <div class="d-none d-md-flex flex-grow-1 align-items-center">
                                        <span class="ad-offer-dotted w-100" style="border-bottom: 2px dotted var(--primary-color); height: 1px; margin-bottom: 8px;"></span>
                                    </div>
                                </div>
                                <div class="text-end">
                                    <div class="d-flex flex-column">
            ...
            @if(isset($content->meta['counters']) && is_array($content->meta['counters']))
                ...
                <div class="col-6 col-md-3">
                    <div class="text-center p-4 rounded-4" style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); backdrop-filter: blur(10px); transition: transform 0.3s ease;">
                        <i class="{{ $counter['icon'] ?? 'fa-light fa-circle' }} fa-3x mb-3" style="color: var(--primary-color);"></i>
            ...
            @else
                <div class="col-6 col-md-3">
                    <div class="text-center p-4 rounded-4" style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1);">
                        <i class="fa-light fa-face-smile fa-3x mb-3" style="color: var(--primary-color);"></i>
                ...
                <div class="col-6 col-md-3">
                    <div class="text-center p-4 rounded-4" style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1);">
                        <i class="fa-light fa-hat-chef fa-3x mb-3" style="color: var(--primary-color);"></i>
                ...
                <div class="col-6 col-md-3">
                    <div class="text-center p-4 rounded-4" style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1);">
                        <i class="fa-light fa-mug-hot fa-3x mb-3" style="color: var(--primary-color);"></i>
                ...
                <div class="col-6 col-md-3">
                    <div class="text-center p-4 rounded-4" style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1);">
                        <i class="fa-light fa-star fa-3x mb-3" style="color: var(--primary-color);"></i>
                        ...
                        <div class="cart-action-wrapper" data-product="${product_id}">
                            <div class="add-to-cart-initial-btn">
                                <button class="btn btn-primary btn-sm rounded-pill w-100 addToCart" 
                                        ...
                                        style="height: 38px; background-color: var(--primary-color); border-color: var(--primary-color);">
                                    Add to Cart
                                </button>
