                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <form action="{{ route('reviewsStore') }}" method="POST" class="bg-light p-4 rounded">
                                ...
                                <button type="submit" class="btn btn-primary-custom" style="background-color:var(--primary-color); border:none; color:#fff; padding:10px 30px; border-radius:50px;">SUBMIT REVIEW</button>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3">
                    <div class="card h-100 border-0 shadow-sm card-hover">
                        ...
                        <div class="card-body p-3 d-flex flex-column text-center">
                            ...
                            <div class="mb-2">
                                <span class="fw-bold" style="font-size: 14px; color: var(--primary-color) !important;">
