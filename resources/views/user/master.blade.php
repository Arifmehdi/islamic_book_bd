...
<head>
    ...
    <style>
        .main-sidebar { background-color: #451647 !important; }
        .sidebar-dark-primary .nav-sidebar > .nav-item > .nav-link.active {
            background-color: #8BCB7A !important;
            color: #5B1E5D !important;
        }
        .brand-link { background-color: #5B1E5D !important; border-bottom: 1px solid rgba(255,255,255,0.1) !important; }
        .navbar-white { background-color: #ffffff !important; border-bottom: 3px solid #5B1E5D !important; }
        .nav-link { color: #5B1E5D !important; }
        .content-wrapper { background-color: #F4E8C8 !important; }
        .main-footer { background-color: #ffffff !important; border-top: 1px solid #dee2e6; color: #5B1E5D; }
        .btn-primary { background-color: #5B1E5D !important; border-color: #5B1E5D !important; }
        .btn-primary:hover { background-color: #2E6B3A !important; border-color: #2E6B3A !important; }
        .card-primary:not(.card-outline) > .card-header { background-color: #5B1E5D !important; }
    </style>
