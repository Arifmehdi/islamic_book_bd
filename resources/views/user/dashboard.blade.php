                                ...
                                <div class="row mt-4">
                                    <div class="col-md-4 mb-3">
                                        <div class="p-4 border rounded text-center bg-white shadow-sm">
                                            <i class="fas fa-shopping-bag fa-2x mb-3" style="color: var(--primary-color);"></i>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="p-4 border rounded text-center bg-white shadow-sm">
                                            <i class="fas fa-cubes fa-2x mb-3" style="color: var(--primary-color);"></i>
                            ...
                            <div class="dashboard-card-body">
                                <form action="{{ route('user.stock_requests.store') }}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <button type="submit" class="btn w-100" style="background: var(--primary-color); color: white; border-radius: 50px; padding: 12px;">SUBMIT REQUEST</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="dashboard-card-body">
                                <form action="#">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <button type="submit" class="btn w-100" style="background: var(--primary-color); color: white; border-radius: 50px; padding: 12px;">UPDATE ACCOUNT</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="p-4 border rounded bg-light">
                                            ...
                                            @endif
                                            <a href="#" class="mt-3 d-inline-block small text-decoration-none" style="color: var(--primary-color);">Edit Address</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
