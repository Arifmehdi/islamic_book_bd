...
<div class="cart-action-wrapper" 
    ...
    @if($cart)
        ...
        <div class="d-flex align-items-center gap-2">
            <div class="d-flex align-items-center border rounded-pill overflow-hidden bg-light" style="height: 38px; border-color: #5B1E5D !important;">
    ...
    @else
        <!-- Initial "Buy Now" button for item NOT in cart -->
