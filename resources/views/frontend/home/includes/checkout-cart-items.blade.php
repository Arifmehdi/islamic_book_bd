<div class="checkout-card-header" style="background-color: var(--primary-color); border-bottom: 1px solid rgba(0,0,0,0.05);">
                ...
                <tbody id="cartTableBody">
                    @foreach ($cartItems as $cart)
                        <tr class="cart-item-row" data-cart="{{ $cart->id }}">
                            ...
                            <td class="text-end pe-4 py-3 border-bottom-0 fw-bold row-subtotal" 
...
<div id="cartSummaryContainer" class="@if($cartItems->isEmpty()) d-none @endif">
    <div class="p-4 border-top bg-light">
        <div id="savingContainer" class="text-center text-white rounded-pill py-1 fw-bold mb-3 small @if($totalDiscountAmount <= 0) d-none @endif" style="background: var(--primary-color)">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <span class="payable-text fw-bold fs-4" style="color: var(--primary-color);">
