...
<style>
    ...
    .form-control:focus {
        ...
        box-shadow: 0 0 0 0.2rem rgba(91, 30, 93, 0.1);
    }
    .btn-checkout {
        background-color: var(--primary-color);
        color: #fff;
    ...
    .payment-option.active {
        border-color: var(--primary-color);
        background-color: rgba(91, 30, 93, 0.05);
    }
    ...
    <div class="container">
        @if($cartItems->isEmpty())
            <div class="text-center py-5">
                ...
                <a href="{{ route('shop') }}" class="btn btn-primary-custom mt-3" style="background-color: var(--primary-color); color:#fff; padding:10px 30px; border-radius:50px; text-decoration:none;">Go to Shop</a>
            </div>
        @else
            <div class="row">
                        ...
                        <div class="checkout-card-body p-0">
                            ...
                            <div class="p-4 border-top">
                                ...
                                <p class="text-center small text-muted mt-3 mb-0">
                                    By placing your order, you agree to our <a href="#" class="text-decoration-none" style="color: var(--primary-color);">Terms & Conditions</a>.
                                </p>
                            </div>
                        </div>
                    </div>
